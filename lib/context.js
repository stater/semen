...
class Context {
    ...
    get(name) {
        ...
        if ('string' === typeof name) {
            ...
            if (!result) {
                logger.error(new Error(`Invalid Service: The context doesn't have service ${color.magenta(name)}!`));
            }
        ...
        // Get multiple services if the name is an array.
            ...
            logger.error(new Error(`Invalid Name: Getting context services require string or array for param "name"!`));
        }
    }
